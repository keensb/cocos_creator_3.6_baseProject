System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'find', 'director', 'Node', 'log', 'UIOpacity', 'Label', 'tween', 'Vec3', 'BaseNode']);
      ...
      _export("MainEntry", MainEntry = (_dec = ccclass('MainEntry'), _dec2 = property({
        ...
        onLoad() {//engineOverrider.startWrite();//在 creator 底层的JS原型链中 新增或覆盖自定义的业务代码
        }

        start() {
          let son = new (_crd && ClassSon === void 0 ? (_reportPossibleCrUseOfClassSon({
            error: Error()
          }), ClassSon) : ClassSon)();
          log(son.a);
          ...
          let textObj1 = this.test(10, 20); //这里没传入第三个参数, 也就是类型 所以 Object 不起作用 返回的将是默认的 Node

          let textObj2 = this.test(10, 20, Object); //这里没传入第三个参数, 也就是类型 所以 Object 不起作用
...
//# sourceMappingURL=c6f619d6f2ea02b10e82d83a837c4d59ccbd6fca.js.map
    ...
    execute: function () {
      ...
      _export("ClassDictionary", ClassDictionary = class ClassDictionary {
        static getClassNameByTarget(anyObj) {
          if (anyObj) {
            var _str = anyObj.toString();

            if (_str.indexOf("function ") != -1) {
              var _str2 = _str.split(" ")[1];

              return _str2.split("(")[0];
          ...
          var str = Object.prototype.toLocaleString.call(anyObj);
...
//# sourceMappingURL=ae22bd118ff092163e566c4e69e3dafae7014b03.js.map
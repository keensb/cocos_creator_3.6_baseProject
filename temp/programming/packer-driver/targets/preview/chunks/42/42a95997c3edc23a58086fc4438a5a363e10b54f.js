    ...
    execute: function () {
      ...
      _export("MainEntry", MainEntry = (_dec = ccclass('MainEntry'), _dec2 = property({
        ...
        start() {
          ...
          var textObj1 = this.test(10, 20); //这里没传入第三个参数, 也就是类型 所以 Object 不起作用 返回的将是默认的 Node

          var textObj2 = this.test(10, 20, Object); //这里没传入第三个参数, 也就是类型 所以 Object 不起作用
        ...
        test(x, y, inst) {
          var obj = !!inst ? new inst() : new Node();
          obj["x"] = x;
          obj["y"] = y;
          return obj;
        }
...
//# sourceMappingURL=42a95997c3edc23a58086fc4438a5a363e10b54f.js.map